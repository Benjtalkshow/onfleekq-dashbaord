...
const MobileNav = () => {
  ...
  return (
    <div className="rounded-[4rem] p-3 fixed bottom-0 sm:bottom-3 grid w-full sm:w-fit bg-primary md:hidden left-1/2 -translate-x-1/2 sm:-translate-y-1/2 text-center font-semibold">
